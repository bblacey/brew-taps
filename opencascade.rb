class Opencascade < Formula
  ...
  url "http://git.dev.opencascade.org/gitweb/?p=occt.git;a=snapshot;h=V7_0_0;sf=tgz"
  sha256 "5e796569d7426630eff497463185e9ed75e4b4eced051aef5ff6a9ba36cd71f4"
  version "7.0"
  revision 1
  ...
  def install
    ...
    if build.with? "extras"
      ...
      mv prefix/"share/opencascade/samples/tcl", "samples/tcl"
      rmdir prefix/"share/opencascade/samples"
